...
def get_model():
    ...
    model = build_model_from_rootfile('/uscms_data/d2/dsperka/8TeV/MakeTBntuples/CMSSW_5_3_7/src/Histos/RootFiles_ForLimits/combined_BestJetJet2W_M_WprimeRight_Histos-final.root',include_mc_uncertainties=True)
