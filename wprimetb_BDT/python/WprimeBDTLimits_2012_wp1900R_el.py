...
def get_model():
    ...
    model = build_model_from_rootfile('/uscms_data/d2/dsperka/8TeV/MakeTBntuples/CMSSW_5_3_7/src/BDT/RootFiles_ForBDTLimits/electron_BDT_wp1900R_Histos-ge1btags.root',include_mc_uncertainties=True)
...
plot_exp.write_txt('wp1900R_el_bayesian_limits_expected.txt')
plot_obs.write_txt('wp1900R_el_bayesian_limits_observed.txt')
...
report.write_html('htmlout_wp1900R_el')
