...
void plotLimitsBDT(string limitDIR,  string limitFILE,  string titchan)
{
  ...
  string explim = "_bayesian_limits_expected_bdt.txt";
  string obslim = "_bayesian_limits_observed_bdt.txt";
  string thcurve = "_theory_BDT.txt";
  string sRH="_R_";
  string sLH="_L_";
  string sMix="_RL_";
  string mu="mu";
  ...
  if (maxmass==2700) { 
    float xbins[21]={1000,1200,1400,1600,1800,2000,2200,2400,2600,2800};
  }
  ...
  latex4->DrawLatex(0.38, 0.27, "BDT Analysis");
  ...
  c1->SetSelected(c1);
  char pname[100];
  sprintf(pname,"./limit_plots/%s_bayesian_12pt2_BDT.png",limitFILE.c_str());
  c1->Print(pname);
  sprintf(pname,"./limit_plots/%s_bayesian_12pt2_BDT.pdf",limitFILE.c_str());
  c1->Print(pname);
  sprintf(pname,"./limit_plots/%s_bayesian_12pt2_BDT.root",limitFILE.c_str());
  c1->Print(pname);
