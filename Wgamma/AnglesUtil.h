...
namespace kinem{
  ...
  inline double TransvMass(double E1, double E2, double px1, double px2,double py1, double py2);
}
...
inline
double kinem::TransvMass(double E1, double E2,
			 double px1, double px2,
			 double py1, double py2){
  double m = pow(E1+E2,2)-pow(px1+px2,2)-pow(py1+py2,2);
